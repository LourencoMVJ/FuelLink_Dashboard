...
export async function fetchCompanyData(companyRole) {
  ...
  if (transactions.length === 0) {
    ...
    transactions = [
      ...
      { id: 'tx-bt-1', date: dStr(1), type: 'logistics', amount: 57710.00, balance_delta: 57710.00, litres: 39800, order_amount: 40000, loaded_amount: 40000, offloaded_amount: 39800, route_id: 1, entered_by: 'bakers', truck: 'BT-101-GP', driver: 'Liam Gallagher', trailer: 'TR-101-GP', note: 'BK-5510', delivery_note_name: 'pod_5510.pdf', delivery_note_path: 'mock/path', order_proof_name: 'ord_5510.pdf', order_proof_path: 'mock/path', loaded_proof_name: 'load_5510.pdf', loaded_proof_path: 'mock/path', offloaded_proof_name: 'pod_5510.pdf', offloaded_proof_path: 'mock/path', created_at: new Date().toISOString() },
      { id: 'tx-bt-2', date: dStr(2), type: 'logistics', amount: 81480.00, balance_delta: 81480.00, litres: 38800, order_amount: 40000, loaded_amount: 39000, offloaded_amount: 38800, route_id: 4, entered_by: 'bakers', truck: 'BT-103-GP', driver: 'David Ndlovu', trailer: 'TR-103-GP', note: 'BK-5511', delivery_note_name: 'pod_5511.pdf', delivery_note_path: 'mock/path', order_proof_name: 'ord_5511.pdf', order_proof_path: 'mock/path', loaded_proof_name: 'load_5511.pdf', loaded_proof_path: 'mock/path', offloaded_proof_name: 'pod_5511.pdf', offloaded_proof_path: 'mock/path', created_at: new Date().toISOString() },
      { id: 'tx-bt-3', date: dStr(4), type: 'logistics', amount: 35910.00, balance_delta: 35910.00, litres: 37800, order_amount: 38000, loaded_amount: 38000, offloaded_amount: 37800, route_id: 2, entered_by: 'bakers', truck: 'BT-102-GP', driver: 'Carlos Mendes', trailer: 'TR-102-GP', note: 'BK-5512', delivery_note_name: 'pod_5512.pdf', delivery_note_path: 'mock/path', order_proof_name: 'ord_5512.pdf', order_proof_path: 'mock/path', loaded_proof_name: 'load_5512.pdf', loaded_proof_path: 'mock/path', offloaded_proof_name: 'pod_5512.pdf', offloaded_proof_path: 'mock/path', created_at: new Date().toISOString() },
      { id: 'tx-bt-4', date: dStr(5), type: 'logistics', amount: 59160.00, balance_delta: 59160.00, litres: 40800, order_amount: 41000, loaded_amount: 41000, offloaded_amount: 40800, route_id: 1, entered_by: 'bakers', truck: 'BT-104-GP', driver: 'Sipho Zulu', trailer: 'TR-104-GP', note: 'BK-5513', delivery_note_name: null, delivery_note_path: null, order_proof_name: 'ord_5513.pdf', order_proof_path: 'mock/path', loaded_proof_name: null, loaded_proof_path: null, offloaded_proof_name: null, offloaded_proof_path: null, created_at: new Date().toISOString() },
      { id: 'tx-bt-5', date: dStr(7), type: 'logistics', amount: 75240.00, balance_delta: 75240.00, litres: 41800, order_amount: 42000, loaded_amount: 42000, offloaded_amount: 41800, route_id: 3, entered_by: 'bakers', truck: 'BT-101-GP', driver: 'Liam Gallagher', trailer: 'TR-101-GP', note: 'BK-5514', delivery_note_name: 'pod_5514.pdf', delivery_note_path: 'mock/path', order_proof_name: 'ord_5514.pdf', order_proof_path: 'mock/path', loaded_proof_name: 'load_5514.pdf', loaded_proof_path: 'mock/path', offloaded_proof_name: 'pod_5514.pdf', offloaded_proof_path: 'mock/path', created_at: new Date().toISOString() },
      { id: 'tx-bt-6', date: dStr(8), type: 'logistics', amount: 41170.00, balance_delta: 41170.00, litres: 35800, order_amount: 36000, loaded_amount: 36000, offloaded_amount: 35800, route_id: 5, entered_by: 'bakers', truck: 'BT-103-GP', driver: 'Johan Van Der Merwe', trailer: 'TR-103-GP', note: 'BK-5515', delivery_note_name: 'pod_5515.pdf', delivery_note_path: 'mock/path', order_proof_name: 'ord_5515.pdf', order_proof_path: 'mock/path', loaded_proof_name: 'load_5515.pdf', loaded_proof_path: 'mock/path', offloaded_proof_name: 'pod_5515.pdf', offloaded_proof_path: 'mock/path', created_at: new Date().toISOString() },
      { id: 'tx-bt-7', date: dStr(11), type: 'logistics', amount: 78840.00, balance_delta: 78840.00, litres: 43800, order_amount: 44000, loaded_amount: 44000, offloaded_amount: 43800, route_id: 3, entered_by: 'bakers', truck: 'BT-102-GP', driver: 'Mateus Silveira', trailer: 'TR-102-GP', note: 'BK-5516', delivery_note_name: 'guia_5516.pdf', delivery_note_path: 'mock/path', order_proof_name: 'ord_5516.pdf', order_proof_path: 'mock/path', loaded_proof_name: 'load_5516.pdf', loaded_proof_path: 'mock/path', offloaded_proof_name: 'guia_5516.pdf', offloaded_proof_path: 'mock/path', created_at: new Date().toISOString() },
      { id: 'tx-bt-8', date: dStr(12), type: 'logistics', amount: 50460.00, balance_delta: 50460.00, litres: 34800, order_amount: 35000, loaded_amount: 35000, offloaded_amount: 34800, route_id: 1, entered_by: 'bakers', truck: 'BT-102-GP', driver: 'Ahmed Khan', trailer: 'TR-102-GP', note: 'BK-5517', delivery_note_name: 'pod_5517.pdf', delivery_note_path: 'mock/path', order_proof_name: 'ord_5517.pdf', order_proof_path: 'mock/path', loaded_proof_name: 'load_5517.pdf', loaded_proof_path: 'mock/path', offloaded_proof_name: 'pod_5517.pdf', offloaded_proof_path: 'mock/path', created_at: new Date().toISOString() },
      { id: 'tx-bt-9', date: dStr(14), type: 'logistics', amount: 57710.00, balance_delta: 57710.00, litres: 39800, order_amount: 40000, loaded_amount: 40000, offloaded_amount: 39800, route_id: 1, entered_by: 'bakers', truck: 'BT-101-GP', driver: 'David Ndlovu', trailer: 'TR-101-GP', note: 'BK-5518', delivery_note_name: null, delivery_note_path: null, order_proof_name: 'ord_5518.pdf', order_proof_path: 'mock/path', loaded_proof_name: 'load_5518.pdf', loaded_proof_path: 'mock/path', offloaded_proof_name: null, offloaded_proof_path: null, created_at: new Date().toISOString() },
      { id: 'tx-bt-10', date: dStr(16), type: 'logistics', amount: 35910.00, balance_delta: 35910.00, litres: 37800, order_amount: 38000, loaded_amount: 38000, offloaded_amount: 37800, route_id: 2, entered_by: 'bakers', truck: 'BT-104-GP', driver: 'Liam Gallagher', trailer: 'TR-104-GP', note: 'BK-5519', delivery_note_name: 'pod_5519.pdf', delivery_note_path: 'mock/path', order_proof_name: 'ord_5519.pdf', order_proof_path: 'mock/path', loaded_proof_name: 'load_5519.pdf', loaded_proof_path: 'mock/path', offloaded_proof_name: 'pod_5519.pdf', offloaded_proof_path: 'mock/path', created_at: new Date().toISOString() },
      { id: 'tx-bt-11', date: dStr(18), type: 'logistics', amount: 58000.00, balance_delta: 58000.00, litres: 40000, order_amount: 40000, loaded_amount: 40000, offloaded_amount: 40000, route_id: 1, entered_by: 'bakers', truck: 'BT-101-GP', driver: 'Carlos Mendes', trailer: 'TR-101-GP', note: 'BK-5520', delivery_note_name: 'pod_5520.pdf', delivery_note_path: 'mock/path', order_proof_name: 'ord_5520.pdf', order_proof_path: 'mock/path', loaded_proof_name: 'load_5520.pdf', loaded_proof_path: 'mock/path', offloaded_proof_name: 'pod_5520.pdf', offloaded_proof_path: 'mock/path', created_at: new Date().toISOString() },
      { id: 'tx-bt-12', date: dStr(19), type: 'logistics', amount: 77040.00, balance_delta: 77040.00, litres: 42800, order_amount: 43000, loaded_amount: 43000, offloaded_amount: 42800, route_id: 3, entered_by: 'bakers', truck: 'BT-103-GP', driver: 'Sipho Zulu', trailer: 'TR-103-GP', note: 'BK-5521', delivery_note_name: 'guia_5521.pdf', delivery_note_path: 'mock/path', order_proof_name: 'ord_5521.pdf', order_proof_path: 'mock/path', loaded_proof_name: 'load_5521.pdf', loaded_proof_path: 'mock/path', offloaded_proof_name: 'guia_5521.pdf', offloaded_proof_path: 'mock/path', created_at: new Date().toISOString() },
      { id: 'tx-bt-13', date: dStr(21), type: 'logistics', amount: 53360.00, balance_delta: 53360.00, litres: 36800, order_amount: 37000, loaded_amount: 37000, offloaded_amount: 36800, route_id: 1, entered_by: 'bakers', truck: 'BT-102-GP', driver: 'Johan Van Der Merwe', trailer: 'TR-102-GP', note: 'BK-5522', delivery_note_name: null, delivery_note_path: null, order_proof_name: 'ord_5522.pdf', order_proof_path: 'mock/path', loaded_proof_name: 'load_5522.pdf', loaded_proof_path: 'mock/path', offloaded_proof_name: null, offloaded_proof_path: null, created_at: new Date().toISOString() },
      { id: 'tx-bt-14', date: dStr(23), type: 'logistics', amount: 45770.00, balance_delta: 45770.00, litres: 39800, order_amount: 40000, loaded_amount: 40000, offloaded_amount: 39800, route_id: 5, entered_by: 'bakers', truck: 'BT-104-GP', driver: 'Ahmed Khan', trailer: 'TR-104-GP', note: 'BK-5523', delivery_note_name: 'pod_5523.pdf', delivery_note_path: 'mock/path', order_proof_name: 'ord_5523.pdf', order_proof_path: 'mock/path', loaded_proof_name: 'load_5523.pdf', loaded_proof_path: 'mock/path', offloaded_proof_name: 'pod_5523.pdf', offloaded_proof_path: 'mock/path', created_at: new Date().toISOString() },
