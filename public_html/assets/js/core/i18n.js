...
export const translations = {
  pt: {
    ...
    netBalanceTrendTitle: "Saldo Líquido ao Longo do Tempo",
    netBalanceTrendSubtitle: "Total acumulado após cada transação",
    balanceLabel: "Saldo",
    typeDiesel: "Venda de Diesel",
    typeLogistics: "Logística",
    typeVoid: "Anulação",
    typeSettlement: "Acerto",
    donutTitle: "Distribuição de Volume",
    donutSubtitle: "Proporção de litros por unidade/rota no período",
    donutTitleMonth: "Volume por Mês",
    donutSubtitleMonth: "Litros vendidos em cada mês do ano",
    ...
    // Phase 2: Request Access & User Management
    userManagement: "Gestão de Utilizadores",
    requestAccess: "Solicitar Acesso",
    forgotPasswordTitle: "Recuperar Credenciais ou Solicitar Acesso",
    forgotPasswordSubtitle: "Introduza o seu email institucional para iniciar o processo.",
    sendRequest: "Submeter Pedido",
    backToLogin: "Voltar ao Login",
    requestSentSuccess: "Se esta conta existir, um administrador foi notificado e entrará em contacto.",
    emailAddress: "Endereço de Email",
    usersListTitle: "Diretório de Utilizadores",
    usersListSubtitle: "Administração de contas, perfis e permissões de acesso",
    addUser: "Novo Utilizador",
    userColName: "Nome e Email",
    userColPhone: "Telefone",
    userColCompany: "Empresa",
    userColStatus: "Estado",
    userColCreatedAt: "Data de Criação",
    userColActions: "Ações",
    editUser: "Editar Utilizador",
    managePermissions: "Gerir Permissões",
    active: "Ativo",
    inactive: "Inativo",
    allCompanies: "Todas as Empresas",
    confirmDeactivateTitle: "Desativar Utilizador",
    confirmDeactivateDesc: "Tem a certeza que deseja desativar o acesso deste utilizador? Poderá reativá-lo a qualquer momento.",
    confirmSensitivePermissionTitle: "Confirmar Permissão Sensível",
    confirmSensitivePermissionDesc: "Esta é uma ação com impacto financeiro ou operacional crítico. Deseja aplicar a alteração de permissão:",
    permissionsCatalog: "Painel de Permissões",
    permissionsSubtitle: "Configure os privilégios operacionais e sensíveis de acesso ao sistema",
    operationalGroup: "Operacional",
    sensitiveGroup: "Sensível (Crítico)",
    permissionGranted: "Concedida",
    permissionRevoked: "Revogada",
    saveUser: "Guardar Utilizador",
    cancel: "Cancelar",
    confirm: "Confirmar",
    searchUsersPlaceholder: "Pesquisar por nome ou email...",
    ...
    // User Management
    usersListTitle: "Diretório de Utilizadores",
    usersListSubtitle: "Administração de contas e privilégios de acesso",
    searchUsersPrompt: "Pesquisar Utilizadores",
    searchUsersPlaceholder: "Pesquisar por nome ou email...",
    ...
    resetFilters: "Limpar",
    userPermissionsTitle: "Permissões de Acesso",
    addUser: "Novo Utilizador",
    editUser: "Editar Utilizador",
    managePermissions: "Gerir Permissões",
    userColName: "Nome e Email",
    ...
    active: "Ativo",
    inactive: "Inativo",
    operationalGroup: "Permissões Operacionais",
    sensitiveGroup: "Permissões Sensíveis",
    confirmSensitivePermissionTitle: "Confirmar Permissão Sensível",
    confirmSensitivePermissionDesc: "Esta é uma ação com impacto financeiro ou operacional crítico. Deseja aplicar a alteração de permissão:",
    confirmDeactivateTitle: "Desativar Utilizador",
    confirmDeactivateDesc: "Tem a certeza que deseja desativar o acesso deste utilizador? O acesso será revogado, mas o histórico operacional permanecerá intacto.",
    userFullName: "Nome Completo",
    emailAddress: "Email Institucional",
    userPhone: "Número de Telefone",
    userPassword: "Palavra-passe Inicial",
    passwordMinLength: "Mínimo de 8 caracteres",
    permissionLabel: "Permissão",
    saveUser: "Guardar Utilizador",
    permissionGranted: "Conceder",
    permissionRevoked: "Revogar",
    records: "registos"
  },
  en: {
    // Header & Controls
    ...
    netBalanceTrendTitle: "Net Balance over Time",
    netBalanceTrendSubtitle: "Running total after each transaction",
    balanceLabel: "Balance",
    typeDiesel: "Diesel Sale",
    typeLogistics: "Logistics",
    typeVoid: "Void",
    typeSettlement: "Settlement",
    donutTitle: "Volume Distribution",
    donutSubtitle: "Litres proportion by truck/route in selected period",
    donutTitleMonth: "Volume by Month",
    donutSubtitleMonth: "Litres sold in each month of the year",
    ...
    forgotPasswordTitle: "Recover Credentials or Request Access",
    forgotPasswordSubtitle: "Enter your corporate email address to initiate the process.",
    sendRequest: "Submit Request",
    backToLogin: "Back to Sign In",
    requestSentSuccess: "If this account exists, an administrator has been notified and will be in touch.",
    emailAddress: "Email Address",
    usersListTitle: "User Directory",
    usersListSubtitle: "Account administration, profiles, and access permissions",
    addUser: "Add User",
    userColName: "Name & Email",
    userColPhone: "Phone",
    userColCompany: "Company",
    userColStatus: "Status",
    userColCreatedAt: "Created At",
    ...
    confirmDeactivateDesc: "Are you sure you want to deactivate this user's access? You can reactivate it at any time.",
    confirmSensitivePermissionTitle: "Confirm Sensitive Permission",
    confirmSensitivePermissionDesc: "This is an action with critical financial or operational impact. Do you wish to apply the permission change:",
    permissionsCatalog: "Permissions Panel",
    permissionsSubtitle: "Configure operational and sensitive system access privileges",
    operationalGroup: "Operational",
    sensitiveGroup: "Sensitive (Critical)",
    ...
    // User Management
    usersListTitle: "User Directory",
    usersListSubtitle: "Account administration and access permissions",
    ...
    resetFilters: "Clear",
    userPermissionsTitle: "Access Permissions",
    addUser: "New User",
    editUser: "Edit User",
    managePermissions: "Manage Permissions",
    userColName: "Name & Email",
    ...
    userColPhone: "Phone",
    userColStatus: "Status",
    userColCreatedAt: "Creation Date",
    userColActions: "Actions",
    active: "Active",
    inactive: "Inactive",
    operationalGroup: "Operational Permissions",
    sensitiveGroup: "Sensitive Permissions",
    confirmSensitivePermissionTitle: "Confirm Sensitive Permission",
    confirmSensitivePermissionDesc: "This is an action with critical financial or operational impact. Do you want to apply this permission change:",
    confirmDeactivateTitle: "Deactivate User",
    confirmDeactivateDesc: "Are you sure you want to deactivate this user's access? Access will be revoked, but operational history will remain intact.",
    userFullName: "Full Name",
